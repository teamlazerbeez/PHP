...
class LoggerLogTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertFalse(Log5PHP_InternalLog :: internalDebugging());
    }

    public function testInternalDebuggingIsSetTrue()
    {
        Log5PHP_InternalLog :: internalDebugging(true);
        $this->assertTrue(Log5PHP_InternalLog :: internalDebugging());
    }

    public function testInternalDebuggingIsSetFalse()
    {
        Log5PHP_InternalLog :: internalDebugging(false);
        $this->assertFalse(Log5PHP_InternalLog :: internalDebugging());
    }
