...
/**
 */
require_once(LOG5PHP_DIR . '/LoggerLevel.php');
require_once(LOG5PHP_DIR . '/spi/LoggerLoggingEvent.php');

if (!defined('LOG5PHP_LOGGER_DOM_CONFIGURATOR_XMLNS'))
    /**
     * @ignore
     */
    define('LOG5PHP_LOGGER_DOM_CONFIGURATOR_XMLNS', 'HTTP://WWW.VXR.IT/LOG4PHP/');
...
class ChainsawEventsXmlParser {
    ...
    function startTag($xp, $tag, $attribs)
    {
        switch ($tag) {
            ...
            case LOG5PHP_LOGGER_DOM_CONFIGURATOR_XMLNS.':EVENTSET':
            
                $this->eventSetStarted = true;
                break;

            case 'LOG4PHP:EVENT':
            case LOG5PHP_LOGGER_DOM_CONFIGURATOR_XMLNS.':EVENT':
...
*/            
            ...
            case LOG5PHP_LOGGER_DOM_CONFIGURATOR_XMLNS.':MESSAGE':            
                $this->messageStarted = true;
                break;
            
            case 'LOG4PHP:NDC':
            case LOG5PHP_LOGGER_DOM_CONFIGURATOR_XMLNS.':NDC':
...
*/
            ...
            case LOG5PHP_LOGGER_DOM_CONFIGURATOR_XMLNS.':LOCATIONINFO':
                if ($this->event !== null) {
