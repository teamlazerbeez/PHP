 ...
 * @subpackage src_main_php_Log5PHP_PatternConverter
 */
class Log5PHP_PatternConverter_ClassName extends Log5PHP_PatternConverter_Named {
    ...
    {
        Log5PHP_InternalLog::debug("Log5PHP_PatternConverter_ClassName::LoggerClassNamePatternConverter() precision='$precision'");    
